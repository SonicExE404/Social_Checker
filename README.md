...
people alking about it so i decided to make a just simple tool ( i am still a beginner \_😅_/ ) that can detect these unclaimed social accounts 
...
# How to use
```bash
git clone https://github.com/SonicExE404/Social_Checker/blob/main/social_checker.py
```
-for help type 
```bash
